    ...
    return (
        <>
            <section className="bg-[url('/images/bgimage.avif')] bg-cover bg-center bg-no-repeat w-full min-h-screen flex flex-col items-center px-2 sm:px-6 py-40 sm:py-20">
                <div>
                    <p className="text-4xl sm:6xl font-bold mb-8">
                ...
                <div className="mt-6 w-full max-w-lg ">
                    <div className="relative">
                        <input type="text" placeholder="Search..."
                            className="w-full sm:w-auto px-4 py-3 border border-gray-400 bg-white rounded-full focus:outline-none text-sm font-semibold"
                        />
