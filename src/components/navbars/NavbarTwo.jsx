...
export default function NavbarTwo() {
  ...
  return (
    <header className="bg-white shadow-md px-4 md:px-8 py-4 relative z-50">
      <div className="flex items-center justify-between">
        ...
        <nav className="hidden text-sm lg:text-base gap-6 md:flex lg:gap-8 text-gray-700 font-medium">
